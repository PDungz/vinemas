...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final InputBorder border = getBorder(
      widget.borderColor ?? widget.primaryColor,
      1,
    );
    ...
    final InputBorder disabledBorder = getBorder(
      ...
      children: [
        if (widget.label != null)
          Padding(
            ...
            child: Text(
              widget.label!,
              style: TextStyle(color: widget.labelColor ?? widget.primaryColor),
            ),
          ),
        TextFormField(
