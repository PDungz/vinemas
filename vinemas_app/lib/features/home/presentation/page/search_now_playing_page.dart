...
import 'package:vinemas_app/core/global/global_bloc/global_bloc.dart';
...
import 'package:vinemas_app/features/home/presentation/bloc/now_playing_bloc/now_playing_bloc.dart';
import 'package:vinemas_app/features/home/presentation/widget/filter_search_widget.dart';
import 'package:vinemas_app/features/home/presentation/widget/search_list_now_playing_loading.dart';
import 'package:vinemas_app/features/home/presentation/widget/search_list_now_playing_widget.dart';
                    ...
                    nowPlaying =
                        nowPlaying.where((movie) {
                          ...
                          final matchesGenres =
                              ...
                              movie.genreIds.any(
                                (id) => selectedGenreIds.contains(id),
                              );

                          final movieReleaseDate = DateTime.tryParse(
                            movie.releaseDate,
                          );
                          final fromDate = FormatDateTime.parseFromDDMMYYYY(
                            dateFrom,
                          );
                          final toDate = FormatDateTime.parseFromDDMMYYYY(
                            dateTo,
                          );
