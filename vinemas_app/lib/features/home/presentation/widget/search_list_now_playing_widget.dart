...
import 'package:vinemas_app/core/container/widget/network_image_empty_widget.dart';
        ...
        return GestureDetector(
          onTap: () {
            context.read<SessionBloc>().add(
              CreatSessionCinemaEvent(movie: nowPlaying[index]),
            );

            Get.toNamed(
              ConfigRoute.aboutSessionsPage,
