...
import 'package:vinemas_app/features/home/data/model/movie_model.dart';

abstract class NowPlayingRemoteDataSource {
  Future<List<MovieModel>?> getNowPlaying({String language, int page});
}
  ...
  Future<List<MovieModel>?> getNowPlaying({
    ...
    try {
      ...
      final response = await dio.get(
        ...
        queryParameters: {'language': localLanguage, 'page': page},
      );
