...
import 'package:vinemas_app/features/login/presentation/widget/form_login_widget.dart';
import 'package:vinemas_app/features/login/presentation/widget/other_sign_in_widget.dart';
import 'package:vinemas_app/features/login/presentation/widget/sign_up_login_widget.dart';
        ...
        builder: (context, state) {
          return Scaffold(
            body: SafeArea(
              child: CustomLayout(
                isLoading:
                    state is loginWithThirdPartyState &&
