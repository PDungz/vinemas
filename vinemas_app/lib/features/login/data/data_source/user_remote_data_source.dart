...
import 'package:vinemas_app/features/login/data/model/user_model.dart';
...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  Future<void> loginWithGoogle({
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        await createUserInfo(userId: userId, user: user, onPressed: onPressed);
  ...
  Future<String?> uploadImage({
    ...
    if (imageFile == null) {
      onPressed(message: "No image selected", status: ProcessStatus.failure);
  ...
  Future<void> loginWithEmailPassword({
    ...
    try {
      ...
      if (userCredential.user != null) {
        onPressed(message: "Login successful", status: ProcessStatus.success);
        printS(
      ...
      onPressed(message: errorMessage, status: ProcessStatus.failure);
      printE(
  ...
  Future<void> logout({
    ...
    try {
      ...
      onPressed(message: "Logout successful", status: ProcessStatus.success);
      printS('User logged out successfully - Remote Data Source Impl');
    } catch (e) {
      onPressed(message: "Logout failed", status: ProcessStatus.failure);
