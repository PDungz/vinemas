...
import 'package:vinemas_app/core/utils/currency_formatter.dart';
...
import 'package:vinemas_app/features/pay/presentation/pay_bloc/pay_bloc.dart';
import 'package:vinemas_app/features/pay/presentation/widget/pay_app_bar_widget.dart';
import 'package:vinemas_app/features/pay/presentation/widget/pay_bill_ticket_widget.dart';
import 'package:vinemas_app/features/pay/presentation/widget/pay_method_widget.dart';
              ...
              CustomLayoutLabelValue(
                ...
                widgetRight: Text(
                  currentPrice.formatCurrency(
                    currencyCode:
                        AppLocalizations.of(context)!.keyword_currency_format,
                  ),
                ),
              ).paddingSymmetric(horizontal: 12),
                          ...
                          context.read<PayBloc>().add(
                            PaymentTicketEvent(
                              ...
                              currency:
                                  AppLocalizations.of(
                                    context,
                                  )!.keyword_currency_format.toLowerCase(),
