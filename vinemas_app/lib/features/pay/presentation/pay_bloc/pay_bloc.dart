...
class PayBloc extends Bloc<PayEvent, PayState> {
  ...
  Future<void> paymentTicket(
    ...
    try {
      ...
      SessionMovie sessionMovie = event.sessionMovie.copyWith(
  ...
  Future<void> paymentTicketChangeShowTime(
    PaymentTicketChangeShowTimeEvent event,
    Emitter<PayState> emit,
  ) async {
    try {
      emit(PaymentTicketState(processStatus: ProcessStatus.loading));
      ...
      final updatedNewChairStatuses = Map<String, ChairStatus>.from(
        event.sessionMovie.chairStatuses,
      );
