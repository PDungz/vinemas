...
import 'package:vinemas_app/features/about_sessions/presentation/widget/about/about_loading_widget.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/about/about_movie_rating.dart';
...
class AboutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AboutBloc>(
      create:
          (context) => AboutBloc()..add(MovieDetailEvent(movieId: movie.id)),
      child: Stack(
        children: [
                        ...
                        case ProcessStatus.success:
                          ...
                          if (movieDetail != null) {
                            final listGenres = aboutState.movieDetail?.genres
                                .map((e) => e.name)
                                .join(', ');
                            final director = aboutState.movieCastCrew?.crew
                                .firstWhere(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: AboutMovieRating(
                                    widgetLeft: Text('8.3'),
                                    widgetRight: Text(
                                      aboutState.movieDetail?.voteAverage
                                              .toStringAsFixed(1) ??
                                          '0.0',
                                    ),
                                  ),
                                ...
                                _buildContent(
                                  ...
                                  widgetContent: Text(director?.name ?? ''),
                                ),
                                SizedBox(height: 8),
                                _buildContent(
                                  context: context,
  ...
  Widget _buildContent({
    ...
    return CustomLayoutLabelValue(
      widgetLeft: Text(
        ...
        style: Theme.of(
          context,
        ).textTheme.titleSmall?.copyWith(color: AppColor.secondaryTextColor),
      ),
