...
import 'package:vinemas_app/features/about_sessions/domain/entity/session/cinema_band.dart';
import 'package:vinemas_app/features/about_sessions/presentation/bloc/about_bloc/about_bloc.dart';
import 'package:vinemas_app/features/about_sessions/presentation/bloc/session_bloc/session_bloc.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/session/session_cinema_schedule_movie_loading_widget.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/session/session_cinema_schedule_movie_widget.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/session/session_cinema_widget.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/session/session_filter_day_widget.dart';
import 'package:vinemas_app/features/about_sessions/presentation/widget/session/session_title_cinema_location_widget.dart';
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverPersistentHeader(
              pinned: true,
              delegate: _HeaderDelegate(onFilterChanged: updateFilter),
            ),
            SliverToBoxAdapter(
              child: SessionCinemaWidget(onCinemaSelected: updateCinemaBand),
            ),
            SliverToBoxAdapter(child: SessionTitleCinemaLocationWidget()),
            SliverToBoxAdapter(
