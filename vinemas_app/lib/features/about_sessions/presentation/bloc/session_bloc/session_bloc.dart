...
class SessionBloc extends Bloc<SessionEvent, SessionState> {
  ...
  Future<void> getCinemaAndSessionMovie(
    SessionCinemaAndSessionMovieEvent event,
    Emitter<SessionState> emit,
  ) async {
    try {
  ...
  Future<void> getCinema(
    ...
    try {
      ...
      emit(
        SessionCinemaState(state: ProcessStatus.failure, message: e.toString()),
      );
    }
  }

  Future<void> getSessionMovie(
    SessionSessionMovieEvent event,
    Emitter<SessionState> emit,
  ) async {
    try {
  ...
  Future<void> createSessionMovie(
    CreatSessionCinemaEvent event,
    Emitter<SessionState> state,
  ) async {
    try {
      ...
      final endDate = startDate.add(
        Duration(minutes: ((runtime + 29) ~/ 30) * 30),
      );
