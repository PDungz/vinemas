...
import 'package:vinemas_app/features/about_sessions/data/model/session/chair_config_model.dart';
import 'package:vinemas_app/features/about_sessions/data/model/session/cinema_band_model.dart';
import 'package:vinemas_app/features/about_sessions/data/model/session/cinema_model.dart';
...
class SessionRemoteDataSourceImpl implements SessionRemoteDataSource {
  ...
  Future<void> updateSessionMovie({
    required SessionMovieModel sessionMovie,
  }) async {
    try {
      await _firestore
  ...
  Future<CinemaModel?> getCinemaDetail({required String cinemaId}) async {
    try {
      ...
      CinemaModel data = CinemaModel.fromJson(
  ...
  Future<SessionMovieModel?> getSessionMovieDetail({
    ...
    try {
      ...
      return SessionMovieModel.fromJson(
        doc.data() as Map<String, dynamic>,
