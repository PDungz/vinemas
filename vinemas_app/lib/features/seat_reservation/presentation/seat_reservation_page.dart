...
import 'package:vinemas_app/core/common/extension/seat_extenstion.dart';
...
import 'package:vinemas_app/features/about_sessions/presentation/bloc/session_bloc/session_bloc.dart';
import 'package:vinemas_app/features/seat_reservation/presentation/widget/seat_button_book_ticket_widget.dart';
import 'package:vinemas_app/features/seat_reservation/presentation/widget/seat_loading_widget.dart';
import 'package:vinemas_app/features/seat_reservation/presentation/widget/seat_reservation_app_bar_widget.dart';
          ...
          children: [
            Column(
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.keyword_screen,
                  ...
                  builder: (context, stateTicket) {
                    if (stateTicket is SeatMovieTicketState &&
                      ...
                      return GridView.builder(
                        ...
                        itemCount:
                            (chairConfig.seatsPerRow * chairConfig.rowCount)
                                as int,
                        itemBuilder: (context, index) {
                          ...
                          if (chairConfig.chairTypes['regular']!.contains(
                            row.name,
                          )) {
                            seatColor = SeatTypeEnum.regular.color;
                          } else if (chairConfig.chairTypes['vip']!.contains(
                            row.name,
                          )) {
                          ...
                          if (sessionMovie.chairStatuses.containsKey(
                            '${row.name}$seatNumber',
                          )) {
                            seatColor = SeatTypeEnum.reserved.color;
                          }
                          if (bookedSeats.contains('${row.name}$seatNumber')) {
                            seatColor = SeatTypeEnum.selected.color.withOpacity(
                              0.4,
                            );
                          }
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              child:
                                  sessionMovie.chairStatuses.containsKey(
                                            '${row.name}$seatNumber',
                                          ) &&
