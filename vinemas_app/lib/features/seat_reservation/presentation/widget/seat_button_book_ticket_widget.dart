...
import 'package:vinemas_app/features/seat_reservation/presentation/widget/seat_reservation_list_title_seat_widget.dart';
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              SeatReservationListTitleSeatWidget().paddingSymmetric(
                horizontal: 16,
              ),
              const CustomDivider(
                thickness: 8,
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      SvgPicture.asset(
                        $AssetsIconsGen().iconApp.location,
                        height: 16,
                      ),
                      SizedBox(width: 2),
                      Expanded(
